...
-- Products (112 catalog items, Dollar General store)
insert into public.products (
  ...
  (
    ...
    2.85, 2.42, 3.56, 96, true, true, false, now(), 'dg-monster-original', 4, '/products/dg-monster-original.png'
  ),
  (
    'cccc0001-0000-4000-8000-000000000001',
    'Monster Zero Ultra', 'Monster', 'Zero sugar, light citrus', '16 oz', 'Zero Ultra',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.85, 2.42, 3.56, 98, true, true, false, now(), 'dg-monster-zero-ultra', 4, '/products/dg-monster-zero-ultra.png'
  ),
  (
    'cccc0001-0000-4000-8000-000000000040',
    'Monster Ultra Rosá', 'Monster', 'Zero sugar, fruity floral', '16 oz', 'Ultra Rosá',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.85, 2.42, 3.56, 88, true, true, false, now(), 'dg-monster-ultra-rosa', 4, '/products/dg-monster-ultra-rosa.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000041',
    'Monster Ultra Paradise', 'Monster', 'Zero sugar, island fruit', '16 oz', 'Ultra Paradise',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.85, 2.42, 3.56, 87, true, true, false, now(), 'dg-monster-ultra-paradise', 4, '/products/dg-monster-ultra-paradise.jpg'
  ),
  (
  ...
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 72, true, true, false, now(), 'dg-redbull-pear-cinnamon', 4, '/products/dg-redbull-pear-cinnamon.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 82, true, true, false, now(), 'dg-redbull-dragon-fruit', 4, '/products/dg-redbull-dragon-fruit.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 81, true, true, false, now(), 'dg-redbull-juneberry', 4, '/products/dg-redbull-juneberry.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000004d',
    'Red Bull Yellow Edition Tropical', 'Red Bull', 'Tropical yellow edition', '8.4 oz', 'Tropical',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 83, true, true, false, now(), 'dg-redbull-tropical', 4, '/products/dg-redbull-tropical.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000004e',
    'Red Bull Blue Edition Blueberry', 'Red Bull', 'Blueberry edition', '8.4 oz', 'Blueberry',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 84, true, true, false, now(), 'dg-redbull-blueberry', 4, '/products/dg-redbull-blueberry.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 80, true, true, false, now(), 'dg-redbull-coconut-berry', 4, '/products/dg-redbull-coconut-berry.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000050',
    'Red Bull Red Edition Watermelon', 'Red Bull', 'Watermelon edition', '8.4 oz', 'Watermelon',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 85, true, true, false, now(), 'dg-redbull-watermelon', 4, '/products/dg-redbull-watermelon.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 82, true, true, false, now(), 'dg-redbull-peach-nectarine', 4, '/products/dg-redbull-peach-nectarine.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000052',
    'Red Bull White Peach', 'Red Bull', 'White peach energy drink', '8.4 oz', 'White Peach',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 81, true, true, false, now(), 'dg-redbull-white-peach', 4, '/products/dg-redbull-white-peach.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000053',
    'Red Bull Iced Vanilla Berry', 'Red Bull', 'Iced vanilla berry', '8.4 oz', 'Iced Vanilla Berry',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 79, true, true, false, now(), 'dg-redbull-iced-vanilla-berry', 4, '/products/dg-redbull-iced-vanilla-berry.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000054',
    'Red Bull Strawberry Apricot', 'Red Bull', 'Strawberry apricot', '8.4 oz', 'Strawberry Apricot',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 78, true, true, false, now(), 'dg-redbull-strawberry-apricot', 4, '/products/dg-redbull-strawberry-apricot.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000055',
    'Red Bull Wild Berries', 'Red Bull', 'Wild berries', '8.4 oz', 'Wild Berries',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 80, true, true, false, now(), 'dg-redbull-wild-berries', 4, '/products/dg-redbull-wild-berries.jpg'
  ),
  (
    ...
    3.15, 2.68, 3.94, 92, true, true, false, now(), 'dg-doritos-nacho', 3, '/products/dg-doritos-nacho.png'
  ),
  (
    'cccc0001-0000-4000-8000-000000000060',
    'Doritos Cool Ranch', 'Doritos', 'Tortilla chips', '9.25 oz', 'Cool Ranch',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    3.15, 2.68, 3.94, 88, true, true, false, now(), 'dg-doritos-cool-ranch', 3, '/products/dg-doritos-cool-ranch.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000061',
    'Doritos Sweet & Tangy BBQ', 'Doritos', 'Tortilla chips', '9.25 oz', 'Sweet & Tangy BBQ',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    3.15, 2.68, 3.94, 80, true, true, false, now(), 'dg-doritos-bbq', 3, '/products/dg-doritos-bbq.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000062',
    'Doritos Flamin'' Hot Nacho', 'Doritos', 'Flamin'' Hot tortilla chips', '9.25 oz', 'Flamin'' Hot Nacho',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    3.15, 2.68, 3.94, 90, true, true, false, now(), 'dg-doritos-fh-nacho', 3, '/products/dg-doritos-fh-nacho.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000063',
    'Cheetos Crunchy Cheese', 'Cheetos', 'Crunchy cheese snacks', '8.5 oz', 'Crunchy Cheese',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    3.15, 2.68, 3.94, 86, true, true, false, now(), 'dg-cheetos-crunchy', 3, '/products/dg-cheetos-crunchy.jpg'
  ),
  (
  ...
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    4.5, 3.83, 5.63, 75, true, true, false, now(), 'dg-tostitos-restaurant', 3, '/products/dg-tostitos-restaurant.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000001a',
    'Pringles Original', 'Pringles', 'Stackable potato crisps', '2.3 oz', 'Original',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    1.75, 1.49, 2.19, 84, true, true, false, now(), 'dg-pringles-orig', 4, '/products/dg-pringles-orig.png'
  ),
  (
    'cccc0001-0000-4000-8000-00000000006c',
    'Pringles Sour Cream & Onion', 'Pringles', 'Stackable potato crisps', '2.3 oz', 'Sour Cream & Onion',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    1.75, 1.49, 2.19, 83, true, true, false, now(), 'dg-pringles-sco', 4, '/products/dg-pringles-sco.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000007',
    'Takis Fuego', 'Takis', 'Hot chili pepper & lime tortilla chips', '9.9 oz', 'Fuego',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    4.15, 3.53, 5.19, 97, true, true, false, now(), 'dg-takis-fuego', 3, '/products/dg-takis-fuego.png'
  ),
  (
    'cccc0001-0000-4000-8000-000000000016',
    'Munchies Cheese Fix', 'Munchies', 'Cheese snack mix', '8 oz', 'Cheese Fix',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    3.65, 3.1, 4.56, 79, true, true, false, now(), 'dg-munchies-cheese', 3, '/products/dg-munchies-cheese.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000006d',
    'Goldfish Cheddar', 'Goldfish', 'Cheddar crackers', '6.6 oz', 'Cheddar',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    2.95, 2.51, 3.69, 87, true, true, false, now(), 'dg-goldfish-cheddar', 3, '/products/dg-goldfish-cheddar.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000014',
    'Cheez-It Original', 'Cheez-It', 'Baked cheese crackers', '3 oz', 'Original',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    1.25, 1.06, 1.56, 86, true, true, false, now(), 'dg-cheezit-orig-3', 4, '/products/dg-cheezit-orig-3.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000015',
    'Cheez-It White Cheddar', 'Cheez-It', 'White cheddar crackers', '7 oz', 'White Cheddar',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    2.75, 2.34, 3.44, 82, true, true, false, now(), 'dg-cheezit-white-7', 3, '/products/dg-cheezit-white-7.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000018',
    'Ritz Toasted Chips Sour Cream & Onion', 'Ritz', 'Toasted chips', '8.1 oz', 'Sour Cream & Onion',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', '11111111-1111-1111-1111-111111111111',
    4.35, 3.7, 5.44, 73, true, true, false, now(), 'dg-ritz-sco', 3, '/products/dg-ritz-sco.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000001e',
    'OREO Original', 'OREO', 'Chocolate sandwich cookies', '13.7 oz', 'Original',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    4.5, 3.83, 5.63, 91, true, true, false, now(), 'dg-oreo-orig', 3, '/products/dg-oreo-orig.png'
  ),
  (
    'cccc0001-0000-4000-8000-00000000001d',
    'CHIPS AHOY! Original Chocolate Chip', 'CHIPS AHOY!', 'Real chocolate chip cookies', '18 oz', 'Original',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    4.75, 4.04, 5.94, 89, true, true, false, now(), 'dg-chipsahoy-orig', 3, '/products/dg-chipsahoy-orig.png'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    4, 3.4, 5, 80, true, true, false, now(), 'dg-chipsahoy-chunky', 3, '/products/dg-chipsahoy-chunky.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    3.75, 3.19, 4.69, 76, true, true, false, now(), 'dg-chipsahoy-ice-cream', 3, '/products/dg-chipsahoy-ice-cream.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    5, 4.25, 6.25, 78, true, true, false, now(), 'dg-nutter-butter', 2, '/products/dg-nutter-butter.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000025',
    'Keebler Fudge Stripes', 'Keebler', 'Fudge-striped shortbread cookies', '11.5 oz', 'Fudge Stripes',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    3.5, 2.98, 4.38, 81, true, true, false, now(), 'dg-keebler-fudge-stripes', 3, '/products/dg-keebler-fudge-stripes.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000001c',
    'Keebler Chips Deluxe with M&M''s', 'Keebler', 'Cookies with M&M''s', '9.75 oz', 'M&M''s',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    3.5, 2.98, 4.38, 83, true, true, false, now(), 'dg-keebler-deluxe-mm', 3, null
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    3.95, 3.36, 4.94, 84, true, true, false, now(), 'dg-little-bites-chip', 3, '/products/dg-little-bites-chip.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000071',
    'Quaker Chewy Strawberry Yogurt', 'Quaker Chewy', 'Granola bar', '0.84 oz', 'Strawberry Yogurt',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    0.85, 0.72, 1.06, 72, true, true, false, now(), 'dg-quaker-strawberry', 6, '/products/dg-quaker-strawberry.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    0.85, 0.72, 1.06, 74, true, true, false, now(), 'dg-quaker-pb-chip', 6, '/products/dg-quaker-pb-chip.jpg'
  ),
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6', '11111111-1111-1111-1111-111111111111',
    1.25, 1.06, 1.56, 77, true, true, false, now(), 'dg-nature-valley-oats', 5, '/products/dg-nature-valley-oats.jpg'
  ),
  (
    ...
    1.5, 1.27, 1.88, 88, true, true, false, now(), 'dg-mms-milk', 5, '/products/dg-mms-milk.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000002f',
    'M&M''S Peanut', 'M&M''S', 'Peanut chocolate candies', '2.55 oz', 'Peanut',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4', '11111111-1111-1111-1111-111111111111',
    1.5, 1.27, 1.88, 89, true, true, false, now(), 'dg-mms-peanut', 5, '/products/dg-mms-peanut.jpg'
  ),
  (
  ...
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4', '11111111-1111-1111-1111-111111111111',
    0.25, 0.21, 0.31, 76, true, true, false, now(), 'dg-mikeike-tropical', 10, '/products/dg-mikeike-tropical.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000031',
    'Mike and Ike Watermelon', 'Mike and Ike', 'Chewy watermelon candy', '0.78 oz', 'Watermelon',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4', '11111111-1111-1111-1111-111111111111',
    0.25, 0.21, 0.31, 75, true, true, false, now(), 'dg-mikeike-watermelon', 10, '/products/dg-mikeike-watermelon.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000074',
    'Mike and Ike Mega Mix Sour', 'Mike and Ike', 'Sour chewy candy mix', '5 oz', 'Mega Mix Sour',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4', '11111111-1111-1111-1111-111111111111',
    1.75, 1.49, 2.19, 73, true, true, false, now(), 'dg-mikeike-mega-sour', 4, '/products/dg-mikeike-mega-sour.jpg'
  ),
  (
  ...
  (
    ...
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    1.65, 1.4, 2.06, 70, true, true, false, now(), 'dg-propel-kiwi-strawberry', 4, '/products/dg-propel-kiwi-strawberry.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000086',
    'Capri Sun Fruit Punch', 'Capri Sun', 'Juice pouch', '6 oz', 'Fruit Punch',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.75, 0.64, 0.94, 80, true, true, false, now(), 'dg-caprisun-fruit-punch', 6, '/products/dg-caprisun-fruit-punch.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000087',
    'Capri Sun Pacific Cooler', 'Capri Sun', 'Juice pouch', '6 oz', 'Pacific Cooler',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.75, 0.64, 0.94, 78, true, true, false, now(), 'dg-caprisun-pacific', 6, '/products/dg-caprisun-pacific.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000088',
    'Capri Sun Wild Cherry', 'Capri Sun', 'Juice pouch', '6 oz', 'Wild Cherry',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.75, 0.64, 0.94, 77, true, true, false, now(), 'dg-caprisun-wild-cherry', 6, '/products/dg-caprisun-wild-cherry.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-000000000089',
    'Capri Sun Lemonade', 'Capri Sun', 'Juice pouch', '6 oz', 'Lemonade',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.75, 0.64, 0.94, 76, true, true, false, now(), 'dg-caprisun-lemonade', 6, '/products/dg-caprisun-lemonade.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000008a',
    'Kool-Aid Bursts Berry Blue', 'Kool-Aid Bursts', 'Juice drink', '6.75 oz', 'Berry Blue',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.85, 0.72, 1.06, 79, true, true, false, now(), 'dg-koolaid-bursts-blue', 6, '/products/dg-koolaid-bursts-blue.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000008b',
    'Kool-Aid Jammers Tropical Punch', 'Kool-Aid Jammers', 'Juice drink', '6 oz', 'Tropical Punch',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    0.85, 0.72, 1.06, 78, true, true, false, now(), 'dg-koolaid-jammers-tropical', 6, '/products/dg-koolaid-jammers-tropical.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000008c',
    'Mott''s Original Apple Juice', 'Mott''s', 'Apple juice', '6.75 oz', 'Original Apple',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    1.25, 1.06, 1.56, 74, true, true, false, now(), 'dg-motts-apple', 4, '/products/dg-motts-apple.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000008d',
    'Bubly Lime', 'Bubly', 'Sparkling water', '12 oz', 'Lime',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111',
    1.25, 1.06, 1.56, 72, true, true, false, now(), 'dg-bubly-lime', 4, '/products/dg-bubly-lime.jpg'
  ),
  (
    ...
    5.49, 4.67, 6.86, 77, true, true, false, now(), 'dg-jack-original', 2, '/products/dg-jack-original.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000000e',
    'Jack Link''s Teriyaki Beef Jerky', 'Jack Link''s', 'Teriyaki beef jerky', '3.25 oz', 'Teriyaki',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5', '11111111-1111-1111-1111-111111111111',
    5.49, 4.67, 6.86, 84, true, true, false, now(), 'dg-jack-teriyaki', 2, '/products/dg-jack-teriyaki.jpg'
  ),
  (
    'cccc0001-0000-4000-8000-00000000000f',
    'Slim Jim', 'Slim Jim', 'Meat stick', 'Giant', 'Original',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5', '11111111-1111-1111-1111-111111111111',
    1.65, 1.4, 2.06, 65, true, true, false, now(), 'dg-slimjim', 5, '/products/dg-slimjim.jpg'
  )
on conflict (id) do update set
  name = excluded.name,
