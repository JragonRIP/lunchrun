...
export const DEMO_PRODUCTS: Product[] = [
  ...
  snack({ id: "p-oreo-minis", name: "OREO Minis Original", brand: "OREO", description: "Mini sandwich cookies", size: "3.5 oz", flavor: "Original", category_id: "cat-snacks", price: 1.5, popularity: 91, max_quantity: 4, external: "dg-oreo-minis" }),
  snack({ id: "p-chipsahoy-minis", name: "CHIPS AHOY! Minis Chocolate Chip", brand: "CHIPS AHOY!", description: "Mini chocolate chip cookies", size: "3.5 oz", flavor: "Chocolate Chip", category_id: "cat-snacks", price: 1.5, popularity: 89, max_quantity: 4, external: "dg-chipsahoy-minis" }),
  snack({ id: "p-chipsahoy-orig", name: "CHIPS AHOY! Original Chocolate Chip", brand: "CHIPS AHOY!", description: "Chocolate chip cookies", size: "13 oz", flavor: "Original Chocolate Chip", category_id: "cat-snacks", price: 3.75, popularity: 85, max_quantity: 3, external: "dg-chipsahoy-orig" }),
